...
DOCUMENTATION
  ...
  p.txt             Documentation on the p pda simulator
  pda.txt           Introduction to pda model
  readme.txt        This document
  register.txt      Summary of the register instruction set
  stack.txt         Summary of the stack instruction set
  t.txt             Documentation on the t Turing machine simulator
  turing.txt        Introduction to Turing machines, 
...
eee          Name file used by e program
...
o            J1 object file
p            pda quintuple file
pp           pda tape file
ppp          p program name file
pog          log file for the p program
s            Source code for testing compilers
t            Turing machine quintuple file
tt           Turing machine tape file
ttt          t program name file
tg           Translation grammar
tog          log file for the t program
